...
// Search redirect is handled by the live search script in app.blade.php
...
// Best Sellers
var swiperBestSellers = null;
if (document.querySelector(".swiper-best-sellers")) {
  swiperBestSellers = new Swiper(".swiper-best-sellers", {
    navigation: {
      prevEl: "#best-sellers-grid .swiper-button-prev",
      nextEl: "#best-sellers-grid .swiper-button-next",
    },
    loop: false,
    slidesPerView: 2,
    spaceBetween: 12,
