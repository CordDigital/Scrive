...
<div class="row mx-3 my-4">
    ...
    <div class="col-12 d-flex justify-content-between align-items-center mb-4">
        <div>
            <h4 class="font-weight-bold mb-1">Social Links</h4>
            <p class="text-muted mb-0">Manage your social media links</p>
        </div>
        <a href="{{ route('admin.social.create') }}" class="btn btn-primary btn-icon-text">
                ...
                <div class="card border-0" style="background: linear-gradient(135deg, #667eea 0%, #764ba2 100%);">
                    <div class="card-body d-flex align-items-center justify-content-between py-4">
                        ...
                        <div class="rounded-circle d-flex align-items-center justify-content-center"
                            ...
                            <i class="mdi mdi-share-variant text-white" style="font-size:2rem;"></i>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <table class="table table-hover align-middle">
                        <thead style="background: linear-gradient(135deg, #667eea 0%, #764ba2 100%);">
                            <tr>
                                ...
                                <th class="text-white border-0">Platform</th>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <span class="font-weight-medium">{{ ucfirst($link->platform) }}</span>
                                </td>
                                <td>
                                    <div class="d-flex align-items-center gap-2">
                                        <div class="rounded-circle d-flex align-items-center justify-content-center"
                                             style="background: linear-gradient(135deg, #667eea, #764ba2); width:40px; height:40px;">
                                ...
                                <td>
                                    <a href="{{ $link->url }}" target="_blank" class="text-muted small">
                                ...
                                <td>
                                    <div class="d-flex gap-2">
                                        <a href="{{ route('admin.social.edit', $link) }}"
                                        ...
                                        <form action="{{ route('admin.social.destroy', $link) }}"
                                              method="POST" id="delete-form-{{ $link->id }}">
                                            @csrf @method('DELETE')
                                            <button type="button"
                            ...
                            <tr>
                                <td colspan="7" class="text-center py-5">
                                    <i class="mdi mdi-share-variant text-muted" style="font-size:4rem;"></i>
                                    <p class="text-muted mt-3 mb-2">No social links found</p>
                                    <a href="{{ route('admin.social.create') }}" class="btn btn-sm btn-primary">
                                        Add your first link
                                    </a>
                                </td>
                            </tr>
