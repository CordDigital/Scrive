...
<div class="row mx-3 my-4">
    ...
    <div class="col-12 d-flex justify-content-between align-items-center mb-4">
        <div>
            <h4 class="font-weight-bold mb-1">Create Benefit</h4>
            <p class="text-muted mb-0">Add a new benefit to your homepage</p>
        </div>
                        ...
                        <div class="card-body pt-4">
                            ...
                            <div class="input-group">
                                <span class="input-group-text"
                                    ...
                                    <i id="iconPreview" class="fa-solid fa-star text-white"></i>
                                </span>
                                <input type="text"
                                       name="icon"
                                       id="iconInput"
                            ...
                            <div class="mt-3 p-3 rounded"
                                ...
                                <div class="d-flex align-items-center gap-3">
                                    <div class="rounded-circle d-flex align-items-center justify-content-center"
                                        ...
                                        <i id="iconPreviewLarge" class="fa-solid fa-star text-white"
                                           style="font-size: 1.5rem;"></i>
                                    </div>
                                    <div>
                                        <p class="mb-0 font-weight-medium">Icon Preview</p>
                                        <small class="text-muted" id="iconClassText">fa-solid fa-star</small>
                                    </div>
                                </div>
                            </div>
...
<script>
    function previewIcon(value) {
        ...
        document.getElementById('iconClassText').textContent = value || 'fa-solid fa-star';
    }
