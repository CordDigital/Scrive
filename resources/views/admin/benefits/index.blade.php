...
<div class="row mx-3 my-4">
    ...
    <div class="col-12 d-flex justify-content-between align-items-center mb-4">
        <div>
            <h4 class="font-weight-bold mb-1">Benefits</h4>
            <p class="text-muted mb-0">Manage your homepage benefits section</p>
        </div>
        <a href="{{ route('admin.benefits.create') }}" class="btn btn-primary btn-icon-text">
        ...
        <div class="row">
            ...
            <div class="col-md-4 mb-3">
                <div class="card border-0" style="background: linear-gradient(135deg, #667eea 0%, #764ba2 100%);">
                    <div class="card-body d-flex align-items-center justify-content-between py-4">
                        <div>
                            <p class="mb-1 text-white" style="opacity: 0.8; font-size: 0.85rem;">Total Benefits</p>
                            <h2 class="mb-0 font-weight-bold text-white">{{ $total }}</h2>
                            <small class="text-white" style="opacity: 0.7;">All benefits in system</small>
                        </div>
                        <div class="rounded-circle d-flex align-items-center justify-content-center"
                             style="background: rgba(255,255,255,0.2); width: 65px; height: 65px;">
                            <i class="mdi mdi-star text-white" style="font-size: 2rem;"></i>
                        </div>
                    </div>
            ...
            <div class="col-md-4 mb-3">
                <div class="card border-0" style="background: linear-gradient(135deg, #11998e 0%, #38ef7d 100%);">
                    <div class="card-body d-flex align-items-center justify-content-between py-4">
                        <div>
                            <p class="mb-1 text-white" style="opacity: 0.8; font-size: 0.85rem;">Active Benefits</p>
            ...
            <div class="col-md-4 mb-3">
                <div class="card border-0" style="background: linear-gradient(135deg, #f093fb 0%, #f5576c 100%);">
                    <div class="card-body d-flex align-items-center justify-content-between py-4">
                        <div>
                            <p class="mb-1 text-white" style="opacity: 0.8; font-size: 0.85rem;">Inactive Benefits</p>
                    ...
                    <table class="table table-hover align-middle">
                        <thead style="background: linear-gradient(135deg, #667eea 0%, #764ba2 100%);">
                            <tr>
                                ...
                                <th class="text-white border-0">Icon</th>
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>
                                    <span class="font-weight-bold text-muted">#{{ $benefit->id }}</span>
                                </td>
                                <td>
                                    <div class="d-flex align-items-center gap-2">
                                        <div class="rounded-circle d-flex align-items-center justify-content-center"
                                             style="background: linear-gradient(135deg, #667eea, #764ba2); width: 40px; height: 40px; flex-shrink: 0;">
                                            <i class="{{ $benefit->icon }} text-white"></i>
                                        </div>
                                        <small class="text-muted">{{ $benefit->icon }}</small>
                                    </div>
                                </td>
                                <td>{{ $benefit->title_ar }}</td>
                                ...
                                <td>
                                    <div class="d-flex gap-2">
                                        ...
                                        <form action="{{ route('admin.benefits.destroy', $benefit) }}"
                                              method="POST"
                                              id="delete-form-{{ $benefit->id }}">
                                            @csrf
                                            @method('DELETE')
                                            <button type="button"
                            ...
                            <tr>
                                <td colspan="7" class="text-center py-5">
                                    <i class="mdi mdi-star-off text-muted" style="font-size: 4rem;"></i>
                                    <p class="text-muted mt-3 mb-2">No benefits found</p>
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content border-0 shadow">
            ...
            <div class="modal-body text-center py-5">
                ...
                <p class="text-muted mb-0">You are about to delete this benefit.</p>
