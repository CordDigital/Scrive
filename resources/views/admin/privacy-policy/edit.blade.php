...
<div class="row mx-3 my-4">
    ...
    <div class="col-12 d-flex justify-content-between align-items-center mb-4">
        <div>
            <h4 class="font-weight-bold mb-1">Privacy Policy</h4>
            <p class="text-muted mb-0">Manage your privacy policy content</p>
        </div>
    ...
    <div class="col-12">
        <form action="{{ route('admin.privacy-policy.update') }}" method="POST" id="privacy-form">
            @csrf
            @method('PUT')
                    ...
                    <div class="card border-0 shadow-sm mb-4">
                        ...
                        <div class="card-body pt-3">
                            <div class="d-flex justify-content-between py-2 border-bottom">
                                ...
                                <small class="font-weight-medium">Privacy Policy</small>
                            </div>
